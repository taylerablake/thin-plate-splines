    ...
    for(j in 1:mfdim[2]){
      ...
      if(lencidx==1L){
        ...
        if(lenpchk==0L){
          ...
          npchk=(1:2)[-pchk]  
          if(is.null(rks$kn[[cidx[npchk]]])==FALSE){
            if(effect=="all" || effect=="lin"){
          ...
          if(effect=="all" || effect=="non"){
            ...
            if(pred==FALSE){Qmats=cbind(Qmats,rks$qm[[cidx[npchk]]]*as.numeric(theknots[[cidx[pchk]]]))}
            Jnames=c(Jnames,paste(xnames[cidx[1]],xnames[cidx[2]],sep=":"))
          }
        } else if(effect=="all" || effect=="lin"){
        ...
        if(lenpchk==0L){
          ...
          npchk=(1:3)[-pchk]
          if(any(c(is.null(rks$kn[[cidx[npchk[1]]]]),is.null(rks$kn[[cidx[npchk[2]]]])))==FALSE){
            if(effect=="all" || effect=="lin"){
          ...
          if(is.null(rks$kn[[cidx[npchk[2]]]])==FALSE){
            if(effect=="all" || effect=="non"){
              ...
              if(pred==FALSE){Qmats=cbind(Qmats,rks$qm[[cidx[npchk[1]]]]*tcprod(rks$qn[[cidx[npchk[2]]]])*as.numeric(theknots[[cidx[pchk]]]))}
              Jnames=c(Jnames,paste(xnames[cidx[1]],xnames[cidx[2]],xnames[cidx[3]],sep=":"))
            }
          }
          if(is.null(rks$kn[[cidx[npchk[1]]]])==FALSE){
            if(effect=="all" || effect=="non"){
              Jmats=cbind(Jmats,rks$jm[[cidx[npchk[2]]]]*tcprod(rks$kn[[cidx[npchk[1]]]],rks$qn[[cidx[npchk[1]]]])*as.numeric(xvars[[cidx[pchk]]]))
              if(pred==FALSE){Qmats=cbind(Qmats,rks$qm[[cidx[npchk[2]]]]*tcprod(rks$qn[[cidx[npchk[1]]]])*as.numeric(theknots[[cidx[pchk]]]))}
              Jnames=c(Jnames,paste(xnames[cidx[1]],xnames[cidx[2]],xnames[cidx[3]],sep=":"))
            }
          }
          if(effect=="all" || effect=="non"){
            Jmats=cbind(Jmats,rks$jm[[cidx[npchk[1]]]]*rks$jm[[cidx[npchk[2]]]]*as.numeric(xvars[[cidx[pchk]]]))
            if(pred==FALSE){Qmats=cbind(Qmats,rks$qm[[cidx[npchk[1]]]]*rks$qm[[cidx[npchk[2]]]]*as.numeric(theknots[[cidx[pchk]]]))}
            Jnames=c(Jnames,paste(xnames[cidx[1]],xnames[cidx[2]],xnames[cidx[3]],sep=":"))
          }
        } else if(lenpchk==2L){
          npchk=(1:3)[-pchk]
          ...
          if(effect=="all" || effect=="non"){
            ...
            if(pred==FALSE){Qmats=cbind(Qmats,rks$qm[[cidx[npchk]]]*as.numeric(theknots[[cidx[pchk[1]]]]*theknots[[cidx[pchk[2]]]]))}
            Jnames=c(Jnames,paste(xnames[cidx[1]],xnames[cidx[2]],xnames[cidx[3]],sep=":"))
          }
        } else if(effect=="all" || effect=="lin"){
