...
\iff    W \bigg[ Bd + \left(K  + \lambda \left(W^\prime D^{-1} W \right)^{-1} \right) c \bigg]  &= Y 
\end{align}
...
\begin{align}
Y &= W \bigg[ Bd + \left(K  + \lambda \left(W^\prime D^{-1} W \right)^{-1} \right) c \bigg] \\
B' c  &= 0  
\end{align}
...
\] 
\noindent
for some $\gamma \in \mathrm{R}^{n-d_0}$. 
